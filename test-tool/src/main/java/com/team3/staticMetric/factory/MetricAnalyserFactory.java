...
import com.team3.staticMetric.analyser.impl.UncaughtErrorMetricAnalyser; 
import com.team3.staticMetric.analyser.impl.InheritanceDepthMetricAnalyser;
...
public class MetricAnalyserFactory {
    ...
    public static IMetricAnalyser create(String metricId) {
        return switch (metricId.toUpperCase()) {
            ...
            case "UNCAUGHT_ERR"  -> new UncaughtErrorMetricAnalyser(); 
            case "DIT_AVG" -> new InheritanceDepthMetricAnalyser();
